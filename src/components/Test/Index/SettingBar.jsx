...
class SettingBar extends Component {
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
        ...
        if (barCurrId === this.props.data.barCurrId)
            // 去除无效点击
            return;
        this.setState({
        ...
        return (
            <CatchErrorBoundary>
                ...
                <Input
                    ...
                    value={currHeight}
                    onChange={(e) => this.handleContentChange(e, "currHeight")}
                />
                <span>颜色: </span>
                <Input
                    size="small"
                    ...
                    style={{ width: "100px", marginRight: 10 }}
                    value={currColor}
                    onChange={(e) => this.handleContentChange(e, "currColor")}
                />
                <span>材质: </span>
                <Input
                    size="small"
                    ...
                    style={{ width: "100px", marginRight: 10 }}
                    value={currTexture}
                    onChange={(e) => this.handleContentChange(e, "currTexture")}
                />
                <Button type="primary" size="small" onClick={() => this.handleSendUp()}>
                    提交
                </Button>
            </CatchErrorBoundary>
        );
