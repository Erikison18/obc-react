...
import { HashRouter as Router, Prompt, withRouter, Link } from "react-router-dom";
                    ...
                    <div style={{ height: "100%" }}>
                        ...
                        <Router getUserConfirmation={getConfirmation} keyLength={12}>
                            <CatchErrorBoundary>
                                ...
                                <ul>
                                    <li>
                                        <Link to="/auth/123/workhome/project">简单的redux例子</Link>
                                    </li>
                                    <li>
                                        <Link to="/unauth">简单的async redux例子</Link>
                                    </li>
                                    <li>
                                        <Link to="/complex">一个稍复杂的例子（redux models包含多个reduce的例子、多个action关联）</Link>
                                    </li>
                                    <li>
                                        <Link to="/amap">amap</Link>
                                    </li>
                                    <li>
                                        <Link to="/amap1">amap1</Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <Link to="/reselector">reselector</Link>
                                    </li>
                                    <li>
                                        <Link to="/keepAlive/1">/keepAlive/:1</Link>
                                    </li>
                                    <li>
                                        <Link to="/keepAlive/2">/keepAlive/:2</Link>
                                    </li>
                                    <li>
                                        <Link to="/3m">3m</Link>
                                    </li>
...
class Layout extends Component {
    render() {
        ...
        //     key='';
        // }
        return renderRoutes(routes, this.props, { location: this.props.location });
    }
}
